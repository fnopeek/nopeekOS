//! Emit spell's AppMeta as a binary blob under $OUT_DIR, linked into the
...
fn main() {
    let meta = AppMeta {
        display_name: "Spell".into(),
        description:  "Text editor with markdown preview".into(),
        icon:         IconRef::Builtin(IconId::FileText),
    };
