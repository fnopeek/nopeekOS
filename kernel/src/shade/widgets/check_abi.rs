...
const _: () = {
    ...
    assert!(IconId::Camera            as u16 == 29);
    assert!(IconId::BatteryEmpty      as u16 == 30);
    assert!(IconId::BatteryLow        as u16 == 31);
    assert!(IconId::BatteryMedium     as u16 == 32);
    assert!(IconId::BatteryHigh       as u16 == 33);
